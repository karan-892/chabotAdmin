        ...
        <div className="lg:w-64">
          <nav className="space-y-1">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="w-full h-10 bg-gray-700 rounded-md animate-pulse"></div>
            ))}
          </nav>
        </div>
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 animate-pulse">
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="w-24 h-8 bg-gray-700 rounded mb-1"></div>
              ...
              <div>
                <div className="w-8 h-4 bg-gray-700 rounded mb-2"></div>
            ...
            <div className="flex items-center justify-between pt-6 mt-6 border-t border-gray-700">
              ...
              <div className="w-28 h-10 bg-gray-700 rounded"></div>
            </div>
          </div>
        </div>
      </div>
