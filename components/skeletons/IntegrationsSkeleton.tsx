...
export default function IntegrationsSkeleton() {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header Skeleton */}
      <div className="mb-8">
        <div className="w-32 h-8 bg-gray-700 rounded mb-2 animate-pulse"></div>
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="w-20 h-8 bg-gray-700 rounded-full animate-pulse"></div>
        ))}
      </div>
      ...
      <div className="mt-12 bg-gray-800 border border-gray-700 rounded-lg p-8 text-center animate-pulse">
        <div className="w-12 h-12 bg-gray-700 rounded mx-auto mb-4"></div>
        <div className="w-48 h-6 bg-gray-700 rounded mb-2 mx-auto"></div>
        <div className="w-64 h-4 bg-gray-700 rounded mb-6 mx-auto"></div>
