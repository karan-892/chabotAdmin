...
export default function BillingSkeleton() {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 mb-8 animate-pulse">
      ...
      {/* Plans Skeleton */}
      <div className="mb-8">
        <div className="w-32 h-6 bg-gray-700 rounded mb-6 animate-pulse"></div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="bg-gray-800 border border-gray-700 rounded-lg p-6 animate-pulse">
              <div className="text-center mb-6">
                <div className="w-16 h-5 bg-gray-700 rounded mb-2 mx-auto"></div>
                <div className="w-20 h-8 bg-gray-700 rounded mx-auto"></div>
              </div>
          ...
          {Array.from({ length: 3 }).map((_, index) => (
            <div key={index} className="flex items-center justify-between py-3 border-b border-gray-700">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <div className="w-48 h-4 bg-gray-700 rounded mb-1"></div>
