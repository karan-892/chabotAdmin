    ...
    <div className="h-full p-6">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="bg-black border rounded-lg p-6">
          ...
          {bot.deploymentUrl && (
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-300 mb-2">Bot URL</label>
        ...
        <div className="bg-black border rounded-lg p-6">
          ...
          <p className="text-gray-400 mb-4">Copy this code to embed the chat widget on your website:</p>
        ...
        <div className="bg-gray-800 rounded-lg p-6">
          ...
          <p className="text-gray-400 mb-4">Use this API key to integrate with your bot programmatically:</p>
          <div className="flex items-center space-x-2">
            <input
              type="text"
              value={bot.apiKey}
